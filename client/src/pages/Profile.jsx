    ...
    <>
      <div className="p-3 max-w-lg mx-auto">
        ...
        <form className="flex flex-col gap-4">
          ...
          <img className="rounded-full h-24 w-24 object-cover cursor-pointer self-center" src={formData.avatar || currentUser.avatar} alt="profile" onClick={() => fileRef.current.click()} />
